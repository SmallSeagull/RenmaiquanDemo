...
/**
 * Created by Dolphin on 2018/8/11.
 */
...
public class AddressPickTask extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    protected void onPostExecute(ArrayList<Province> result) {
        ...
        if (result.size() > 0) {
            ...
            picker.setTopPadding(ConvertUtils.toPx(activity, 15));
            picker.setDividerColor(activity.getResources().getColor(R.color.linecolor));
            picker.setTextColor(activity.getResources().getColor(R.color.color_666666));
            picker.setCancelTextColor(activity.getResources().getColor(R.color.color_666666));
            picker.setSubmitTextColor(activity.getResources().getColor(R.color.secondcolor));
            picker.setTopLineColor(activity.getResources().getColor(R.color.linecolor));
            picker.setBackgroundColor(activity.getResources().getColor(R.color.white));
            picker.setHeight((int)DensityHelper.pt2px(activity,700));
