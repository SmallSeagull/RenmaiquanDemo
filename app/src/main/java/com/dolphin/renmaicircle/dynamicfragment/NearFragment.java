...
public class NearFragment extends BaseFragment {
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        mNearAdapter = new NearAdapter(R.layout.favorite_item,datas);
        mRv.setAdapter(mNearAdapter);
...
//                refreshLayout.finishLoadMore(2000/*,false*/);
    ...
    private class NearAdapter extends BaseQuickAdapter<FavoriteBean.DataBean,BaseViewHolder> {

        private NearAdapter(@LayoutRes int layoutResId, @Nullable List<FavoriteBean.DataBean> data) {
